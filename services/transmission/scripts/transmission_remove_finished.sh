...
echo "Trigger Sickgear to move done files to proper path"
curl "http://sickgear:7081/api/${SICKGEAR_TOKEN}/?cmd=sg.postprocess&path=/downloads&force_replace=0&force_next=1&return_data=0&process_method=move&is_priority=0&failed=0&delete=1&type=auto"

#echo "Trigger Sickchill to move done files to proper path"
